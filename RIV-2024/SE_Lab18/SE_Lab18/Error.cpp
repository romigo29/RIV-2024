...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(120,"Превышено максимальное допустимое количество параметров у функции"),//не используется
		ERROR_ENTRY_NODEF(121),
		ERROR_ENTRY_NODEF(122),
		ERROR_ENTRY(123, "Вышеперечисленные переменные не проициницилизированы"),
		ERROR_ENTRY(124,"Выход за пределы массива"),
		...
		ERROR_ENTRY(129,"Максимальный размер строки/массива 128(не меньше нуля)"),
